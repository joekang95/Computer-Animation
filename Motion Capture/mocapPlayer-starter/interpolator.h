...
public: 
  ...
  void Interpolate(Motion * pInputMotion, Motion ** pOutputMotion, int N, int T);
...
protected:
  ...
  void LinearInterpolationEuler(Motion * pInputMotion, Motion * pOutputMotion, int N, int T);
  void BezierInterpolationEuler(Motion * pInputMotion, Motion * pOutputMotion, int N, int T);
  void LinearInterpolationQuaternion(Motion * pInputMotion, Motion * pOutputMotion, int N, int T);
  void BezierInterpolationQuaternion(Motion * pInputMotion, Motion * pOutputMotion, int N, int T);
