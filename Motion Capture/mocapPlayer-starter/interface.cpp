...
Fl_Choice * dropdown = (Fl_Choice *)0;
Fl_Button * resetCamera_button = (Fl_Button *)0;

Fl_Window * make_window()
{
	Fl_Window * w;
	{
		Fl_Window * o = main_window = new Fl_Window(750, 622, "ASF/AMC Motion Capture Player");
		w = o;
		{
			...
			{
				Fl_Button * o = resetScene_button = new Fl_Button(400, 495, 115, 40, "Reset Scene");
				o->callback((Fl_Callback *)resetScene_callback);
			}

			{
				Fl_Button * o = resetCamera_button = new Fl_Button(530, 495, 115, 40, "Reset Camera");
				o->callback((Fl_Callback *)resetCamera_callback);
			}

			{
				Fl_Light_Button* o = record_button = new Fl_Light_Button(375, 575, 40, 25, "R");
				o->callback((Fl_Callback *)record_callback, (void*)(0));
			}

			{
				Fl_Button * o = screenShot_button = new Fl_Button(270, 575, 90, 25, "ScreenShot");
				o->callback((Fl_Callback *)saveScreenToFile_callback);
			}

			{
				Fl_Button * o = pause_button = new Fl_Button(435, 575, 35, 25, "@||");
				o->labeltype(FL_SYMBOL_LABEL);
				o->labelsize(12);
				o->callback((Fl_Callback *)play_callback);
			}
			{
				Fl_Button* o = rewind_button = new Fl_Button(470, 575, 35, 25, "@|<");
				o->labeltype(FL_SYMBOL_LABEL);
				o->labelsize(12);
				o->callback((Fl_Callback *)play_callback);
			}
			{
				Fl_Button* o = play_button = new Fl_Button(505, 575, 35, 25, "@>");
				o->labeltype(FL_SYMBOL_LABEL);
				o->labelsize(12);
				o->callback((Fl_Callback *)play_callback, (void*)(0));
			}
			{
				Fl_Button* o = minusOne_button = new Fl_Button(540, 575, 35, 25, "-1");
				o->labeltype(FL_SYMBOL_LABEL);
				o->labelsize(12);
				o->callback((Fl_Callback *)play_callback, (void*)(0));
			}
			{
				Fl_Button* o = plusOne_button = new Fl_Button(575, 575, 35, 25, "+1");
				o->labeltype(FL_SYMBOL_LABEL);
				o->labelsize(12);
				o->callback((Fl_Callback *)play_callback, (void*)(0));
			}
			{
				Fl_Button* o = repeat_button = new Fl_Button(610, 575, 35, 25, "@<->");
				o->labeltype(FL_SYMBOL_LABEL);
				o->labelsize(12);
				o->callback((Fl_Callback *)play_callback, (void*)(0));
			}
		...
		{
			Fl_Value_Slider* o = frame_slider = new Fl_Value_Slider(10, 545, 635, 20);  // slider
			o->type(5);
			o->labelsize(18);
			o->minimum(1);
			o->maximum(60000);
		...
		{
			Fl_Choice * o = dropdown = new Fl_Choice(660, 55, 75, 25, "Skeleton ID:");
			o->callback((Fl_Callback *)skeletonID_callback);
